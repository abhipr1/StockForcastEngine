...
'''
@summary: The Portfolio class handles the positions and market
...
# local imports
from events.events_impl import OrderEvent
...
class Portfolio(object):
    ...
    The positions DataFrame stores a time-index of the quantity of
    positions held.
    ...
    def __init__(self, bars, events, start_date, initial_capital=100000.0):
        """
        w the portfolio with bars and an event queue.
        ...
        initial_capital - The starting capital in INR.
        """
        self.bars = bars
        self.events = events
        ...
        self.current_positions = dict((k, v) for k, v in [(s, 0) for s
                                                          in self.symbol_list])
    ...
    def construct_all_positions(self):
        ...
        """
        d = dict((k, v) for k, v in [(s, 0) for s in
                                     self.symbol_list])
